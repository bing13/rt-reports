...
def generate_index_page(starttime, queuelist):
    ...
    pageCode += '<body><h2>generated %s </h2>\n' % starttime
    pageCode += '<ol>'
    for q in queuelist:
...
#QueueList = ['HEP_ref_user']

dirx = 'c:\\Users\\bhecker\\My Documents\\INSPIRE\\RT metrics\\2015-02-13 analyses\\'
inx = dirx+'2015-02-18_vm2_dump.tsv'
# 'c:\\Users\\bhecker\\My Documents\\INSPIRE\\RT metrics\\2015-02-13 analyses\\2015-02-18_vm2_dump.tsv'

# EntireSheet=pd.read_csv(inx, '\2015-02-18_vm2_dump.tsv', delimiter='\t', index_col=None, na_values=['NA'] )
...
## odd structure avoids race condition and avoids file/dir confusion
try: 
    os.makedirs(pathx)
except OSError:
...
for thisQueueName in QueueList:
    ...
    print "===> ",thisQueueName," Queue length:", len(ThisQueueFrame)
